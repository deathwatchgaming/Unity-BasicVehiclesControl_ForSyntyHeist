/*
 * File: Police Charger 02 Camera
 * Name: PoliceCharger02Camera.cs
...
namespace VehiclesControl
{
	// public class PoliceCharger02Camera
	public class PoliceCharger02Camera : MonoBehaviour 
	{
		// Transforms
		[Header("Transforms")]

			[Tooltip("The police charger 02 transform")]
			// Transform _policeCharger02
			[SerializeField] private Transform _policeCharger02;
		...
		private void LateUpdate()
		{
			...
			// float _desiredHeight is _policeCharger02.position.y plus _height
			float _desiredHeight = _policeCharger02.position.y + _height;
			...
			// transform position is _policeCharger02.position
			transform.position = _policeCharger02.position;
			...
			// transform LookAt _policeCharger02
			transform.LookAt(_policeCharger02);
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _policeCharger02.InverseTransformDirection(_policeCharger02.GetComponent<Rigidbody>().linearVelocity);
			...
			if (_localVelocity.z < -0.1f)
			{
				...
				// _tempVector3.y is _policeCharger02.eulerAngles.y plus 180
				_tempVector3.y = _policeCharger02.eulerAngles.y + 180;
			...
			else
			{
				...
				// _tempVector3 y is _policeCharger02.eulerAngles.y
				_tempVector3.y = _policeCharger02.eulerAngles.y;
			...
			float _autoCamControl = _policeCharger02.GetComponent<Rigidbody>().linearVelocity.magnitude;
	...
	} // close public class PoliceCharger02Camera
