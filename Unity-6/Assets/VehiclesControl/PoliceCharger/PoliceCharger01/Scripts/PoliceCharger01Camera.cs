/*
 * File: Police Charger 01 Camera
 * Name: PoliceCharger01Camera.cs
...
namespace VehiclesControl
{
	// public class PoliceCharger01Camera
	public class PoliceCharger01Camera : MonoBehaviour 
	{
		// Transforms
		[Header("Transforms")]

			[Tooltip("The police charger 01 transform")]
		...
		private void LateUpdate()
		{
			...
			// float _desiredHeight is _policeCharger01.position.y plus _height
			float _desiredHeight = _policeCharger01.position.y + _height;
			...
			// transform position is _policeCharger01.position
			transform.position = _policeCharger01.position;
			...
			// transform LookAt _policeCharger01
			transform.LookAt(_policeCharger01);
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _policeCharger01.InverseTransformDirection(_policeCharger01.GetComponent<Rigidbody>().linearVelocity);
			...
			if (_localVelocity.z < -0.1f)
			{
				...
				// _tempVector3.y is _policeCharger01.eulerAngles.y plus 180
				_tempVector3.y = _policeCharger01.eulerAngles.y + 180;
			...
			else
			{
				...
				// _tempVector3 y is _policeCharger01.eulerAngles.y
				_tempVector3.y = _policeCharger01.eulerAngles.y;
			...
			// float _autoCamControl
			float _autoCamControl = _policeCharger01.GetComponent<Rigidbody>().linearVelocity.magnitude;
	...
	} // close public class PoliceCharger01Camera
