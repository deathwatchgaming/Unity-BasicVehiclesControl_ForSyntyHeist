/*
 * File: SwatVan03 Only Speedometer
 * Name: SwatVan03OnlySpeedometer.cs
...
namespace VehiclesControl
{
    // public enum SwatVan03OnlySpeedUnit
	public enum SwatVan03OnlySpeedUnit
	{
		mph,
		kmh	

	} // close public enum SwatVan03OnlySpeedUnit

	// public class SwatVan03OnlySpeedometer 
	public class SwatVan03OnlySpeedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// SwatVan03OnlySpeedUnit _speedUnit	
			[SerializeField] private SwatVan03OnlySpeedUnit _speedUnit;
		...
		private void Update()
		{
			// if _speedUnit equals SwatVan03OnlySpeedUnit.mph
			if (_speedUnit == SwatVan03OnlySpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals SwatVan03OnlySpeedUnit.mph
	...
	} // close public class SwatVan03OnlySpeedometer
