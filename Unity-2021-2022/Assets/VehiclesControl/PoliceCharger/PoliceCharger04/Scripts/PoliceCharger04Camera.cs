...
namespace VehiclesControl
{
	...
	public class PoliceCharger04Camera : MonoBehaviour 
	{
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _policeCharger04.InverseTransformDirection(_policeCharger04.GetComponent<Rigidbody>().velocity);
			...
			float _autoCamControl = _policeCharger04.GetComponent<Rigidbody>().velocity.magnitude;
