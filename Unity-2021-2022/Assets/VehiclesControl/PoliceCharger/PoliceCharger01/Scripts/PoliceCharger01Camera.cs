...
namespace VehiclesControl
{
	...
	public class PoliceCharger01Camera : MonoBehaviour 
	{
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _policeCharger01.InverseTransformDirection(_policeCharger01.GetComponent<Rigidbody>().velocity);
			...
			float _autoCamControl = _policeCharger01.GetComponent<Rigidbody>().velocity.magnitude;
