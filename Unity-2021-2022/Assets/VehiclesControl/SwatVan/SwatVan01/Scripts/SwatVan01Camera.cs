...
namespace VehiclesControl
{
	...
	public class SwatVan01Camera : MonoBehaviour 
	{
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _swatVan01.InverseTransformDirection(_swatVan01.GetComponent<Rigidbody>().velocity);
			...
			float _autoCamControl = _swatVan01.GetComponent<Rigidbody>().velocity.magnitude;
