/*
*  Name: Swat Van 04 Compass
*  File: SwatVan04Compass.cs
...
namespace NavigationControl
{
	// public class SwatVan04Compass
	public class SwatVan04Compass : MonoBehaviour
	{
		// Header
		[Header("Raw Images")]
		...
		[Header("Transform")]
			...
			// Tooltip
			[Tooltip("The SwatVan04 transform")]
		...
		// SwatVan04Compass _swatVan04Compass
		public static SwatVan04Compass _swatVan04Compass;

		// private void Start
		private void Start()
		{
			// _swatVan04Compass
			_swatVan04Compass = this;
		...
		private void Update()
		{
			...
			if (compassEnabled == true)
			{
				...
				// Get Component SwatVan04Compass is enabled
				GetComponent<SwatVan04Compass>().enabled = true;
			...
			else if (compassEnabled == false)
			{
				...
				// Get Component SwatVan04Compass is not enabled
				GetComponent<SwatVan04Compass>().enabled = false;
	...
	} // close public class SwatVan04Compass
