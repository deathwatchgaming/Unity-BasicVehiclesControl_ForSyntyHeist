/*
*  Name: Police Charger 02 Compass
*  File: PoliceCharger02Compass.cs
...
namespace NavigationControl
{
	// public class PoliceCharger02Compass
	public class PoliceCharger02Compass : MonoBehaviour
	{
		// Header
		[Header("Raw Images")]
		...
		[Header("Transform")]
			...
			// Tooltip
			[Tooltip("The PoliceCharger02 transform")]
		...
		public static PoliceCharger02Compass _charger02Compass;

		// private void Start
		private void Start()
		{
			// _charger02Compass
			_charger02Compass = this;
		...
		private void Update()
		{
			...
			if (compassEnabled == true)
			{
				...
				// Get Component PoliceCharger02Compass is enabled
				GetComponent<PoliceCharger02Compass>().enabled = true;

				// Debug Log PoliceCharger02 compass is enabled
				//Debug.Log("The PoliceCharger02 compass is enabled");
			...
			{
				// Debug Log PoliceCharger02 compass is disabled
				//Debug.Log("The PoliceCharger02 compass is disabled");
				...
				// Get Component PoliceCharger02Compass is not enabled
				GetComponent<PoliceCharger02Compass>().enabled = false;
			...
			// Zero out the Y of _policeCharger02 forward vector to only get the direction in the X,Z 
	...
	} // close public class PoliceCharger02Compass
