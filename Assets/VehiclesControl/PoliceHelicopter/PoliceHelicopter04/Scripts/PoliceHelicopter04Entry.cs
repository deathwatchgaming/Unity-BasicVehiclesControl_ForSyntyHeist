...
namespace VehiclesControl
{
    ...
    public class PoliceHelicopter04Entry : MonoBehaviour
    {
        ...
        private void Start() 
        {
            ...
            _policeHelicopter04Camera03 = _cameras[1].GetComponentInChildren<Camera>();
            ...
            // _interfaceTextObject is GameObject Find PoliceHelicopter04_EntryKey
            _interfaceTextObject = GameObject.Find("PoliceHelicopter04_EntryKey");

            // _interfaceTextObject SetActive is false
            _interfaceTextObject.SetActive(false);

            // _interfaceHUDObject is GameObject Find PoliceHelicopter04_HUD
            _interfaceHUDObject = GameObject.Find("PoliceHelicopter04_HUD");
