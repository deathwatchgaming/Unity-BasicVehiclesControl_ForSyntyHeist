...
namespace VehiclesControl
{
    ...
    public class PoliceHelicopter01Entry : MonoBehaviour
    {
        ...
        private void Start() 
        {
            ...
            _policeHelicopter01Camera03 = _cameras[1].GetComponentInChildren<Camera>();
            ...
            // _interfaceTextObject is GameObject Find PoliceHelicopter01_EntryKey
            _interfaceTextObject = GameObject.Find("PoliceHelicopter01_EntryKey");

            // _interfaceTextObject SetActive is false
            _interfaceTextObject.SetActive(false);

            // _interfaceHUDObject is GameObject Find PoliceHelicopter01_HUD
            _interfaceHUDObject = GameObject.Find("PoliceHelicopter01_HUD");
