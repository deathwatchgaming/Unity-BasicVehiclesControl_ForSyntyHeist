/*
 * File: Swat Van 04 Speedometer
 * Name: SwatVan04Speedometer.cs
...
namespace VehiclesControl
{
    // public enum SwatVan04SpeedUnit
	public enum SwatVan04SpeedUnit
	{
		mph,
		kmh	

	} // close public enum SwatVan04SpeedUnit

	// public class SwatVan04Speedometer 
	public class SwatVan04Speedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// SwatVan04SpeedUnit _speedUnit	
			[SerializeField] private SwatVan04SpeedUnit _speedUnit;
		...
		private void Update()
		{
			// if _speedUnit equals SwatVan04SpeedUnit.mph
			if (_speedUnit == SwatVan04SpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals SwatVan04SpeedUnit.mph
	...
	} // close public class SwatVan04Speedometer
