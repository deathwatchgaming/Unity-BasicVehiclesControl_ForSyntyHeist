/*
 * File: Police Charger 04 Entry (New Input System)
...
namespace VehiclesControl
{
    ...
    public class PoliceCharger04Entry : MonoBehaviour
    {
        ...
        private void Start() 
        {
            ...
            // GameObject _interfaceTextObject is FindInActiveObjectByName PoliceCharger04_EntryKey
            GameObject _interfaceTextObject = FindInActiveObjectByName("PoliceCharger04_EntryKey");
