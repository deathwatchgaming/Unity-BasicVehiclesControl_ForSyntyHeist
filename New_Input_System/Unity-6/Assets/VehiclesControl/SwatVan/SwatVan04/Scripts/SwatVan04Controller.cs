/*
 * File: Swat Van 04 Controller (New Input System)
 * Name: SwatVan04Controller.cs
...
namespace VehiclesControl
{
	// public enum SwatVan04SpeedType
	public enum SwatVan04SpeedType
	{
		mph,
		kmh	

	} // close public enum SwatVan04SpeedType
	...
	// public class SwatVan04Controller
	public class SwatVan04Controller : MonoBehaviour
	{					
		// Require Components
		...
		[Header("Speed")]
			...
			// SwatVan04SpeedType _speedType	
			[SerializeField] private SwatVan04SpeedType _speedType;			
		...
		private void Awake()
		{
			...
			// Adjust the center of mass vertically to help prevent the SwatVan04 from rolling
		...
		private void HandleSpeed()
		{
			...
			// _speedType equals SwatVan04SpeedType.mph
			if (_speedType == SwatVan04SpeedType.mph)
			{
			...
			} // close if _speedType equals SwatVan04SpeedType.mph

			// else if _speedType equals SwatVan04SpeedType.kmh
			else if (_speedType == SwatVan04SpeedType.kmh)
			{
			...
			} // close else if _speedType equals SwatVan04SpeedType.kmh
	...
	} // close public class SwatVan04Controller
