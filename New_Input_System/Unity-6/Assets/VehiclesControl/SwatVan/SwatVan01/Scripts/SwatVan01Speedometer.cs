/*
 * File: Swat Van 01 Speedometer (New Input System)
 * Name: SwatVan01Speedometer.cs
...
namespace VehiclesControl
{
    // public enum SwatVan01SpeedUnit
	public enum SwatVan01SpeedUnit
	{
		mph,
		kmh	

	} // close public enum SwatVan01SpeedUnit

	// public class SwatVan01Speedometer 
	public class SwatVan01Speedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// SwatVan01SpeedUnit _speedUnit	
			[SerializeField] private SwatVan01SpeedUnit _speedUnit;
		...
		private void Start()
		{
			...
			// GameObject _interfaceIMG01Object is FindInActiveObjectByName SwatVan01_SpeedoGuage
			GameObject _interfaceIMG01Object = FindInActiveObjectByName("SwatVan01_SpeedoGuage");

			// _interfaceIMG01Object SetActive is false
			_interfaceIMG01Object.SetActive(false);

			// GameObject _interfaceIMG02Object is FindInActiveObjectByName SwatVan01_SpeedoNeedle
			GameObject _interfaceIMG02Object = FindInActiveObjectByName("SwatVan01_SpeedoNeedle");

			// _interfaceIMG02Object SetActive is false
			_interfaceIMG02Object.SetActive(false);

			// GameObject _interfaceTextObject is FindInActiveObjectByName SwatVan01_SpeedText
			GameObject _interfaceTextObject = FindInActiveObjectByName("SwatVan01_SpeedText");

			// _interfaceTextObject SetActive is false
			_interfaceTextObject.SetActive(false);

			// GameObject _interfaceParentObject is FindInActiveObjectByName SwatVan01Speedometer
			GameObject _interfaceParentObject = FindInActiveObjectByName("SwatVan01Speedometer");
		...
		private void Update()
		{
			...
			// if _speedUnit equals SwatVan01SpeedUnit.mph
			if (_speedUnit == SwatVan01SpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals SwatVan01SpeedUnit.mph
			...
			if (_inSwatVan01 && _exitButton == true)
			{
		...
		private void OnTriggerStay(Collider other)
		{
			...
			if (!_inSwatVan01 && other.gameObject.tag == "Player" && _enterButton == true)
			{
	...
	} // close public class SwatVan01Speedometer
