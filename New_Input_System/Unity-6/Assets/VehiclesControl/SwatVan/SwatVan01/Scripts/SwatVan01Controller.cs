/*
 * File: Swat Van 01 Controller (New Input System)
 * Name: SwatVan01Controller.cs
...
namespace VehiclesControl
{
	// public enum SwatVan01SpeedType
	public enum SwatVan01SpeedType
	{
		mph,
		kmh	

	} // close public enum SwatVan01SpeedType
	...
	// public class SwatVan01Controller
	public class SwatVan01Controller : MonoBehaviour
	{					
		// Require Components
		...
		[Header("Speed")]
			...
			// SwatVan01SpeedType _speedType	
			[SerializeField] private SwatVan01SpeedType _speedType;			
		...
		private void Awake()
		{
			...
			// Adjust the center of mass vertically to help prevent the SwatVan01 from rolling
		...
		private void HandleSpeed()
		{
			...
			// _speedType equals SwatVan01SpeedType.mph
			if (_speedType == SwatVan01SpeedType.mph)
			{
			...
			} // close if _speedType equals SwatVan01SpeedType.mph

			// else if _speedType equals SwatVan01SpeedType.kmh
			else if (_speedType == SwatVan01SpeedType.kmh)
			{
			...
			} // close else if _speedType equals SwatVan01SpeedType.kmh
	...
	} // close public class SwatVan01Controller
