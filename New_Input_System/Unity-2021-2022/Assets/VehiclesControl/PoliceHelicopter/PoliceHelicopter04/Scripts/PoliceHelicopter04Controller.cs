/*
 * Name: Police Helicopter 04 Controller (New Input System)
...
namespace VehiclesControl
{
    // public enum PoliceHelicopter04AirspeedType
    public enum PoliceHelicopter04AirspeedType
    {
        mph,
        kmh 

    } // close public enum PoliceHelicopter04AirspeedType
    ...
    // public class PoliceHelicopter04Controller
    public class PoliceHelicopter04Controller : MonoBehaviour 
    {
        // Components
        [Header("Components")]
        ...
        [Header("Airspeed")]
            ...
            // PoliceHelicopter04AirspeedType _airspeedType   
            [SerializeField] private PoliceHelicopter04AirspeedType _airspeedType;            
        ...
        private void HandleAirspeed()
        {
            ...
            } // close if _airspeedType equals PoliceHelicopter04AirspeedType.mph

            // else if _airspeedType equals PoliceHelicopter04AirspeedType.kmh
            else if (_airspeedType == PoliceHelicopter04AirspeedType.kmh)
            {
            ...
            } // close else if _airspeedType equals PoliceHelicopter04AirspeedType.kmh
        ...
        private void UpdateHUD()
        {
            ...
            // if _airspeedType is PoliceHelicopter04AirspeedType.mph
            if (_airspeedType == PoliceHelicopter04AirspeedType.mph)
            {
            ...
            } // close if _airspeedType is PoliceHelicopter04AirspeedType.mph

            // else if _airspeedType is PoliceHelicopter04AirspeedType.kmh
            else if (_airspeedType == PoliceHelicopter04AirspeedType.kmh)
            {
                // 3.6 is the constant to convert a value from m/s to km/h
            ...
            } // close else if _speedType is PoliceHelicopter04AirspeedType.kmh
    ...
    } // close public class PoliceHelicopter04Controller
