/*
 * Name: Police Helicopter 02 Controller (New Input System)
 * File: PoliceHelicopter02Controller.cs
...
namespace VehiclesControl
{
    // public enum PoliceHelicopter02AirspeedType
    public enum PoliceHelicopter02AirspeedType
    {
        mph,
        kmh 

    } // close public enum PoliceHelicopter02AirspeedType
    ...
    // public class PoliceHelicopter02Controller
    public class PoliceHelicopter02Controller : MonoBehaviour 
    {
        // Components
        [Header("Components")]
        ...
        [Header("Airspeed")]
            ...
            // PoliceHelicopter02AirspeedType _airspeedType   
            [SerializeField] private PoliceHelicopter02AirspeedType _airspeedType;            
        ...
        private void HandleAirspeed()
        {
            ...
            // _airspeedType equals PoliceHelicopter02AirspeedType.mph
            if (_airspeedType == PoliceHelicopter02AirspeedType.mph)
            {
            ...
            } // close if _airspeedType equals PoliceHelicopter02AirspeedType.mph

            // else if _airspeedType equals PoliceHelicopter02AirspeedType.kmh
            else if (_airspeedType == PoliceHelicopter02AirspeedType.kmh)
            {
            ...
            } // close else if _airspeedType equals PoliceHelicopter02AirspeedType.kmh
        ...
        private void UpdateHUD()
        {
            ...
            // if _airspeedType is PoliceHelicopter02AirspeedType.mph
            if (_airspeedType == PoliceHelicopter02AirspeedType.mph)
            {
            ...
            } // close if _airspeedType is PoliceHelicopter02AirspeedType.mph

            // else if _airspeedType is PoliceHelicopter02AirspeedType.kmh
            else if (_airspeedType == PoliceHelicopter02AirspeedType.kmh)
            {
                // 3.6 is the constant to convert a value from m/s to km/h
            ...
            } // close else if _speedType is PoliceHelicopter02AirspeedType.kmh
    ...
    } // close public class PoliceHelicopter02Controller
