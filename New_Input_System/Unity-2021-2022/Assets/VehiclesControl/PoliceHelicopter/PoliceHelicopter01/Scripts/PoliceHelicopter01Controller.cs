...
namespace VehiclesControl
{
    // public enum PoliceHelicopter01AirspeedType
    public enum PoliceHelicopter01AirspeedType
    {
        mph,
        kmh 

    } // close public enum PoliceHelicopter01AirspeedType
    ...
    public class PoliceHelicopter01Controller : MonoBehaviour 
    {
        ...
        [Header("Airspeed")]
            ...
            // PoliceHelicopter01AirspeedType _airspeedType   
            [SerializeField] private PoliceHelicopter01AirspeedType _airspeedType;            
        ...
        private void HandleAirspeed()
        {
            ...
            // _airspeedType equals PoliceHelicopter01AirspeedType.mph
            if (_airspeedType == PoliceHelicopter01AirspeedType.mph)
            {
            ...
            } // close if _airspeedType equals PoliceHelicopter01AirspeedType.mph

            // else if _airspeedType equals PoliceHelicopter01AirspeedType.kmh
            else if (_airspeedType == PoliceHelicopter01AirspeedType.kmh)
            {
            ...
            } // close else if _airspeedType equals PoliceHelicopter01AirspeedType.kmh
        ...
        private void UpdateHUD()
        {
            ...
            // if _airspeedType is PoliceHelicopter01AirspeedType.mph
            if (_airspeedType == PoliceHelicopter01AirspeedType.mph)
            {
            ...
            } // close if _airspeedType is PoliceHelicopter01AirspeedType.mph

            // else if _airspeedType is PoliceHelicopter01AirspeedType.kmh
            else if (_airspeedType == PoliceHelicopter01AirspeedType.kmh)
            {
                // 3.6 is the constant to convert a value from m/s to km/h
            ...
            } // close else if _speedType is PoliceHelicopter01AirspeedType.kmh
    ...
    } // close public class PoliceHelicopter01Controller
