/*
 * File: Police Charger 01 Controller (New Input System)
 * Name: PoliceCharger01Controller.cs
...
namespace VehiclesControl
{
	// public enum PoliceCharger01SpeedType
	public enum PoliceCharger01SpeedType
	{
		mph,
		kmh	

	} // close public enum PoliceCharger01SpeedType
	...
	// public class PoliceCharger01Controller
	public class PoliceCharger01Controller : MonoBehaviour
	{					
		// Require Components
		...
		[Header("Speed")]
			...
			// PoliceCharger01SpeedType _speedType	
			[SerializeField] private PoliceCharger01SpeedType _speedType;			
		...
		private void HandleSpeed()
		{
			...
			// _speedType equals PoliceCharger01SpeedType.mph
			if (_speedType == PoliceCharger01SpeedType.mph)
			{
			...
			} // close if _speedType equals PoliceCharger01SpeedType.mph

			// else if _speedType equals PoliceCharger01SpeedType.kmh
			else if (_speedType == PoliceCharger01SpeedType.kmh)
			{
			...
			} // close else if _speedType equals PoliceCharger01SpeedType.kmh
	...
	} // close public class PoliceCharger01Controller
