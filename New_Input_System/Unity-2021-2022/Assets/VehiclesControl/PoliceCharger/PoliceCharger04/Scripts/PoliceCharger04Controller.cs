/*
 * File: Police Charger 04 Controller (New Input System)
 * Name: PoliceCharger04Controller.cs
...
namespace VehiclesControl
{
	// public enum PoliceCharger04SpeedType
	public enum PoliceCharger04SpeedType
	{
		mph,
		kmh	

	} // close public enum PoliceCharger04SpeedType
	...
	// public class PoliceCharger04Controller
	public class PoliceCharger04Controller : MonoBehaviour
	{					
		// Require Components
		...
		[Header("Speed")]
			...
			// PoliceCharger04SpeedType _speedType	
			[SerializeField] private PoliceCharger04SpeedType _speedType;			
		...
		private void HandleSpeed()
		{
			...
			// _speedType equals PoliceCharger04SpeedType.mph
			if (_speedType == PoliceCharger04SpeedType.mph)
			{
			...
			} // close if _speedType equals PoliceCharger04SpeedType.mph

			// else if _speedType equals PoliceCharger04SpeedType.kmh
			else if (_speedType == PoliceCharger04SpeedType.kmh)
			{
			...
			} // close else if _speedType equals PoliceCharger04SpeedType.kmh
	...
	} // close public class PoliceCharger04Controller
