...
namespace VehiclesControl
{
	...
	public class PoliceCharger03Camera : MonoBehaviour 
	{
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _policeCharger03.InverseTransformDirection(_policeCharger03.GetComponent<Rigidbody>().velocity);
			...
			float _autoCamControl = _policeCharger03.GetComponent<Rigidbody>().velocity.magnitude;
