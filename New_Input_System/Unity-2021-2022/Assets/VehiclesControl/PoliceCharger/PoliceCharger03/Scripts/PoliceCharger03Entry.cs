/*
 * File: Police Charger 03 Entry (New Input System)
...
namespace VehiclesControl
{
    ...
    public class PoliceCharger03Entry : MonoBehaviour
    {
        ...
        [Header("Compass")]
            ...
            [Tooltip("The police charger 03 compass")]
            //  PoliceCharger03Compass _charger03Compass
            [SerializeField] private PoliceCharger03Compass _charger03Compass;
        ...
        //public static PoliceCharger03Entry _policeCharger03Entry;         
        ...
        private void Start() 
        {
            ...
            // _charger03Compass enabled is false
            _charger03Compass.enabled = false;

            // _charger03Compass compassEnabled is false
            _charger03Compass.compassEnabled = false;

            // Debug Log
            //Debug.Log("The Charger03 compass is disabled");
        ...
        private void OnTriggerStay(Collider other)
        {
            ...
            if (!_inPoliceCharger03 && other.gameObject.tag == "Player" && _enterButton == true)
            {
                ...
                // _charger03Compass enabled is true
                _charger03Compass.enabled = true;

                // _charger03Compass compassEnabled is true
                _charger03Compass.compassEnabled = true;

                // Debug Log
                //Debug.Log("The Charger03 compass is enabled");
