/*
 * File: Police Charger 03 Controller (New Input System)
 * Name: PoliceCharger03Controller.cs
...
namespace VehiclesControl
{
	// public enum PoliceCharger03SpeedType
	public enum PoliceCharger03SpeedType
	{
		mph,
		kmh	

	} // close public enum PoliceCharger03SpeedType
	...
	// public class PoliceCharger03Controller
	public class PoliceCharger03Controller : MonoBehaviour
	{					
		// Require Components
		...
		[Header("Speed")]
			...
			// PoliceCharger03SpeedType _speedType	
			[SerializeField] private PoliceCharger03SpeedType _speedType;			
		...
		private void HandleSpeed()
		{
			...
			// _speedType equals PoliceCharger03SpeedType.mph
			if (_speedType == PoliceCharger03SpeedType.mph)
			{
			...
			} // close if _speedType equals PoliceCharger03SpeedType.mph

			// else if _speedType equals PoliceCharger03SpeedType.kmh
			else if (_speedType == PoliceCharger03SpeedType.kmh)
			{
			...
			} // close else if _speedType equals PoliceCharger03SpeedType.kmh
	...
	} // close public class PoliceCharger03Controller
