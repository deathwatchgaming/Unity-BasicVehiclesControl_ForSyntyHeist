/*
 * File: SwatVan02 Only Speedometer
 * Name: SwatVan02OnlySpeedometer.cs
...
namespace VehiclesControl
{
    // public enum SwatVan02OnlySpeedUnit
	public enum SwatVan02OnlySpeedUnit
	{
		mph,
		kmh	

	} // close public enum SwatVan02OnlySpeedUnit

	// public class SwatVan02OnlySpeedometer 
	public class SwatVan02OnlySpeedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// SwatVan02OnlySpeedUnit _speedUnit	
			[SerializeField] private SwatVan02OnlySpeedUnit _speedUnit;
		...
		private void Update()
		{
			// if _speedUnit equals SwatVan02OnlySpeedUnit.mph
			if (_speedUnit == SwatVan02OnlySpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals SwatVan02OnlySpeedUnit.mph
	...
	} // close public class SwatVan02OnlySpeedometer
