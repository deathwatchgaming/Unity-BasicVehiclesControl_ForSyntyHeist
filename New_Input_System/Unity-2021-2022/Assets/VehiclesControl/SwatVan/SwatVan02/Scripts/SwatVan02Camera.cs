...
namespace VehiclesControl
{
	...
	public class SwatVan02Camera : MonoBehaviour 
	{
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _swatVan02.InverseTransformDirection(_swatVan02.GetComponent<Rigidbody>().velocity);
			...
			float _autoCamControl = _swatVan02.GetComponent<Rigidbody>().velocity.magnitude;
