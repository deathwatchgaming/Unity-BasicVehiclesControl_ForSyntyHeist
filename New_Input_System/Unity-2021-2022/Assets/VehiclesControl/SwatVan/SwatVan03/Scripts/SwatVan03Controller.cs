/*
 * File: Swat Van 03 Controller (New Input System)
 * Name: SwatVan03Controller.cs
...
namespace VehiclesControl
{
	// public enum SwatVan03SpeedType
	public enum SwatVan03SpeedType
	{
		mph,
		kmh	

	} // close public enum SwatVan03SpeedType
	...
	// public class SwatVan03Controller
	public class SwatVan03Controller : MonoBehaviour
	{					
		// Require Components
		...
		[Header("Speed")]
			...
			// SwatVan03SpeedType _speedType	
			[SerializeField] private SwatVan03SpeedType _speedType;			
		...
		private void Awake()
		{
			...
			// Adjust the center of mass vertically to help prevent the SwatVan03 from rolling
		...
		private void HandleSpeed()
		{
			...
			// _speedType equals SwatVan03SpeedType.mph
			if (_speedType == SwatVan03SpeedType.mph)
			{
			...
			} // close if _speedType equals SwatVan03SpeedType.mph

			// else if _speedType equals SwatVan03SpeedType.kmh
			else if (_speedType == SwatVan03SpeedType.kmh)
			{
			...
			} // close else if _speedType equals SwatVan03SpeedType.kmh
	...
	} // close public class SwatVan03Controller
