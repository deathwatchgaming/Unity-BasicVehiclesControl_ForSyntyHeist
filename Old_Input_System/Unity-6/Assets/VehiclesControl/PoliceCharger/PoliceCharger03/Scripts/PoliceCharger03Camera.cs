/*
 * File: Police Charger 03 Camera
 * Name: PoliceCharger03Camera.cs
...
namespace VehiclesControl
{
	// public class PoliceCharger03Camera
	public class PoliceCharger03Camera : MonoBehaviour 
	{
		// Transforms
		[Header("Transforms")]

			[Tooltip("The police charger 03 transform")]
		...
		private void LateUpdate()
		{
			...
			// float _desiredHeight is _policeCharger03.position.y plus _height
			float _desiredHeight = _policeCharger03.position.y + _height;
			...
			// transform position is _policeCharger03.position
			transform.position = _policeCharger03.position;
			...
			// transform LookAt _policeCharger03
			transform.LookAt(_policeCharger03);
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _policeCharger03.InverseTransformDirection(_policeCharger03.GetComponent<Rigidbody>().linearVelocity);
			...
			if (_localVelocity.z < -0.1f)
			{
				...
				// _tempVector3.y is _policeCharger03.eulerAngles.y plus 180
				_tempVector3.y = _policeCharger03.eulerAngles.y + 180;
			...
			else
			{
				...
				// _tempVector3 y is _policeCharger03.eulerAngles.y
				_tempVector3.y = _policeCharger03.eulerAngles.y;
			...
			float _autoCamControl = _policeCharger03.GetComponent<Rigidbody>().linearVelocity.magnitude;
	...
	} // close public class PoliceCharger03Camera
