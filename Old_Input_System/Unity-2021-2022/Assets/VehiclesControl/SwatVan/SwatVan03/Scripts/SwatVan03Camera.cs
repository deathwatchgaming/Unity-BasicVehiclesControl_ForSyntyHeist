...
namespace VehiclesControl
{
	...
	public class SwatVan03Camera : MonoBehaviour 
	{
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _swatVan03.InverseTransformDirection(_swatVan03.GetComponent<Rigidbody>().velocity);
			...
			float _autoCamControl = _swatVan03.GetComponent<Rigidbody>().velocity.magnitude;
