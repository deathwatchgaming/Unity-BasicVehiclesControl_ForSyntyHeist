/*
 * File: SwatVan04 Only Speedometer
 * Name: SwatVan04OnlySpeedometer.cs
...
namespace VehiclesControl
{
    // public enum SwatVan04OnlySpeedUnit
	public enum SwatVan04OnlySpeedUnit
	{
		mph,
		kmh	

	} // close public enum SwatVan04OnlySpeedUnit

	// public class SwatVan04OnlySpeedometer 
	public class SwatVan04OnlySpeedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// SwatVan04OnlySpeedUnit _speedUnit	
			[SerializeField] private SwatVan04OnlySpeedUnit _speedUnit;
		...
		private void Update()
		{
			// if _speedUnit equals SwatVan04OnlySpeedUnit.mph
			if (_speedUnit == SwatVan04OnlySpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals SwatVan04OnlySpeedUnit.mph
	...
	} // close public class SwatVan04OnlySpeedometer
