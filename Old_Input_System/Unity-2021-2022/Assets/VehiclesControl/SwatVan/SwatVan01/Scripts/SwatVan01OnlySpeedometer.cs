/*
 * File: SwatVan01 Only Speedometer
 * Name: SwatVan01OnlySpeedometer.cs
...
namespace VehiclesControl
{
    // public enum SwatVan01OnlySpeedUnit
	public enum SwatVan01OnlySpeedUnit
	{
		mph,
		kmh	

	} // close public enum SwatVan01OnlySpeedUnit

	// public class SwatVan01OnlySpeedometer 
	public class SwatVan01OnlySpeedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// SwatVan01OnlySpeedUnit _speedUnit	
			[SerializeField] private SwatVan01OnlySpeedUnit _speedUnit;
		...
		private void Update()
		{
			// if _speedUnit equals SwatVan01OnlySpeedUnit.mph
			if (_speedUnit == SwatVan01OnlySpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals SwatVan01OnlySpeedUnit.mph
	...
	} // close public class SwatVan01OnlySpeedometer
