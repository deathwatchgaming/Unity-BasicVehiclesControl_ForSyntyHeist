/*
 * File: PoliceCharger01 Only Speedometer
 * Name: PoliceCharger01OnlySpeedometer.cs
...
namespace VehiclesControl
{
    // public enum PoliceCharger01OnlySpeedUnit
	public enum PoliceCharger01OnlySpeedUnit
	{
		mph,
		kmh	

	} // close public enum PoliceCharger01OnlySpeedUnit

	// public class PoliceCharger01OnlySpeedometer 
	public class PoliceCharger01OnlySpeedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// PoliceCharger01OnlySpeedUnit _speedUnit	
			[SerializeField] private PoliceCharger01OnlySpeedUnit _speedUnit;
		...
		private void Update()
		{
			// if _speedUnit equals PoliceCharger01OnlySpeedUnit.mph
			if (_speedUnit == PoliceCharger01OnlySpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals PoliceCharger01OnlySpeedUnit.mph
	...
	} // close public class PoliceCharger01OnlySpeedometer
