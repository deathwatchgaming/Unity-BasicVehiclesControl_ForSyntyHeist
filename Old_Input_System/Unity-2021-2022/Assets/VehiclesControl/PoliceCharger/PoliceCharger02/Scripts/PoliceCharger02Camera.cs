...
namespace VehiclesControl
{
	...
	public class PoliceCharger02Camera : MonoBehaviour 
	{
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _policeCharger02.InverseTransformDirection(_policeCharger02.GetComponent<Rigidbody>().velocity);
			...
			float _autoCamControl = _policeCharger02.GetComponent<Rigidbody>().velocity.magnitude;
