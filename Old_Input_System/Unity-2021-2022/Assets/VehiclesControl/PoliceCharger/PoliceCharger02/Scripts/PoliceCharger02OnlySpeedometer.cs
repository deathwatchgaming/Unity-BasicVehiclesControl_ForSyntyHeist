/*
 * File: PoliceCharger02 Only Speedometer
 * Name: PoliceCharger02OnlySpeedometer.cs
...
namespace VehiclesControl
{
    // public enum PoliceCharger02OnlySpeedUnit
	public enum PoliceCharger02OnlySpeedUnit
	{
		mph,
		kmh	

	} // close public enum PoliceCharger02OnlySpeedUnit

	// public class PoliceCharger02OnlySpeedometer 
	public class PoliceCharger02OnlySpeedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// PoliceCharger02OnlySpeedUnit _speedUnit	
			[SerializeField] private PoliceCharger02OnlySpeedUnit _speedUnit;
		...
		private void Update()
		{
			// if _speedUnit equals PoliceCharger02OnlySpeedUnit.mph
			if (_speedUnit == PoliceCharger02OnlySpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals PoliceCharger02OnlySpeedUnit.mph
	...
	} // close public class PoliceCharger02OnlySpeedometer
