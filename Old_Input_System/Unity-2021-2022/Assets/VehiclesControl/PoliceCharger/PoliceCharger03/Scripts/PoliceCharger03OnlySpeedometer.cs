/*
 * File: PoliceCharger03 Only Speedometer
 * Name: PoliceCharger03OnlySpeedometer.cs
...
namespace VehiclesControl
{
    // public enum PoliceCharger03OnlySpeedUnit
	public enum PoliceCharger03OnlySpeedUnit
	{
		mph,
		kmh	

	} // close public enum PoliceCharger03OnlySpeedUnit

	// public class PoliceCharger03OnlySpeedometer 
	public class PoliceCharger03OnlySpeedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// PoliceCharger03OnlySpeedUnit _speedUnit	
			[SerializeField] private PoliceCharger03OnlySpeedUnit _speedUnit;
		...
		private void Update()
		{
			// if _speedUnit equals PoliceCharger03OnlySpeedUnit.mph
			if (_speedUnit == PoliceCharger03OnlySpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals PoliceCharger03OnlySpeedUnit.mph
	...
	} // close public class PoliceCharger03OnlySpeedometer
