/*
*  Name: Police Charger 01 Compass
*  File: PoliceCharger01Compass.cs
...
namespace NavigationControl
{
	// public class PoliceCharger01Compass
	public class PoliceCharger01Compass : MonoBehaviour
	{
		// Header
		[Header("Raw Images")]
		...
		[Header("Transform")]
			...
			// Tooltip
			[Tooltip("The PoliceCharger01 transform")]
			// Transform _policeCharger01
			[SerializeField] private Transform _policeCharger01;
		...
		public static PoliceCharger01Compass _charger01Compass;

		// private void Start
		private void Start()
		{
			// _charger01Compass
			_charger01Compass = this;
		...
		private void Update()
		{
			...
			if (compassEnabled == true)
			{
				...
				// Get Component PoliceCharger01Compass is enabled
				GetComponent<PoliceCharger01Compass>().enabled = true;

				// Debug Log PoliceCharger01 compass is enabled
				//Debug.Log("The PoliceCharger01 compass is enabled");
			...
			{
				// Debug Log PoliceCharger01 compass is disabled
				//Debug.Log("The PoliceCharger01 compass is disabled");
				...
				// Get Component PoliceCharger01Compass is not enabled
				GetComponent<PoliceCharger01Compass>().enabled = false;

			} // close else if compassEnabled is false

			// Get a handle on the image's uvRect

			// _compassForeground uvRect is new Rect _policeCharger01 localEulerAngles.y 360, 0, 1, 1
			_compassForeground.uvRect = new Rect(_policeCharger01.localEulerAngles.y / 360, 0, 1, 1);

			// Get a copy of the _policeCharger01 forward vector

			// Vector3 forward is _policeCharger01 transform forward
			Vector3 forward = _policeCharger01.transform.forward;
	...
	} // close public class PoliceCharger01Compass
